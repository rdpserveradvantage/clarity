...
<div class="row">
    <div class="col-sm-12">
        ...
        $sqlappCount = "SELECT count(1) as total FROM material_send where contactPersonName='" . $userid . "' and portal='vendor' ";
        $atm_sql = "SELECT * FROM material_send where contactPersonName='" . $userid . "' and portal='vendor' ";
