                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <select class="form-control atm-status" name="atm1Status">
                                <option value="">Select</option>
                                <option>Yes</option>
                                <option>No</option>
                            </select>
                ...
                <div class="card-block">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <select name="operator" class="form-control">
                                ...
                                while ($operatorSqlResult = mysqli_fetch_assoc($operatorSql)) { ?>
                                    <option value="<?php echo $operatorSqlResult['id']; ?>" <?php if ($operator == $operatorSqlResult['operator']) {
                                           echo 'selected';
                                       } ?>>
                        ...
                        <div class="col-sm-2">
                            ...
                            <input name="backroomNetworkSnap" type="file" />
                        </div>
            ...
            <div class="card second_card grid-margin">
                <div class="card-block">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <input type="file" name="routerPositionSnap" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <input type="file" name="routerAntenaSnap" />
                        </div>
                    </div>
            ...
            <div class="card second_card grid-margin">
                <div class="card-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <input type="file" name="powerSocketAvailabilityUPSSnap" />
                        </div>
                    </div>
